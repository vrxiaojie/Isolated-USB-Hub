...
void OLED_Task(void *arg)
{
  ...
  for (;;)
  {
    ...
    u8g2.setCursor(0, 16);
    u8g2.printf("%4.3f V", busVoltage);
    u8g2.setCursor(0, 32);
    u8g2.printf("%4.3f mA", current_mA);
    u8g2.setCursor(0, 48);
    u8g2.printf("%4.3f mW", power);
    u8g2.sendBuffer();
    delay(10);
  }
}
...
void setup()
{
  ...
  // xTaskCreatePinnedToCore(OLED_Task, "oled", 1024 * 10, NULL, 4, NULL, 1);
  xTaskCreate(INA226_Task, "ina226", 1024 * 10, NULL, 3, NULL);
  xTaskCreate(btn_scan, "knob", 1024 * 20, NULL, 4, NULL);
  // xTaskCreate(ui_proc, "ui process", 1024 * 100, NULL, 5, NULL);
}
